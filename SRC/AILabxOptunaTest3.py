...
def run_strategy(paras: dict, trial_number: int):    # 导入上下文
...
if __name__ == '__main__':
    # 使用数据库存储确保进程安全
    # 20231121-20251028:AILabxOptunaStudy3_001.db # good
    # 20251009-20251103:AILabxOptunaStudy3_002.db # cautious2
    # 20250825-20251105:AILabxOptunaStudy3_003.db # cautious3, good
